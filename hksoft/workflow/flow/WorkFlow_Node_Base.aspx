<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlow_Node_Base.aspx.cs"
    Inherits="hkpro.workflow.flow.WorkFlow_Node_Base" %>
...
<body class="main">
    ...
    <asp:DropDownList ID="lblynEndAudi" runat="server" Visible="False">
        <asp:ListItem>是</asp:ListItem>
        <asp:ListItem>否</asp:ListItem>
    </asp:DropDownList>
    <asp:TextBox ID="lblnextnodenum" runat="server" Style="display: none"></asp:TextBox>
