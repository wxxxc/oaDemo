<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlow_Seal_Add.aspx.cs"
    Inherits="hkpro.workflow.flow.WorkFlow_Seal_Add" %>
...
<script>
    ...
    function chknull() {
        if (document.getElementById('sealarea').value == '请选择') {
            alert('请选择印章域');
...
<body class="main">
    ...
    <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%">
        ...
        <tr>
            ...
            <td width="75%">
                <asp:DropDownList ID="sealarea" runat="server" Width="90%">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
    ...
    <asp:TextBox ID="chUserIDs" runat="server" Style="display: none"></asp:TextBox>
