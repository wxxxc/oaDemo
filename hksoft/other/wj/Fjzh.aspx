                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="height: 30px;" align="right">
                            <input onclick="paste('txt')" type="button" value="粘贴" class="mybtn">
                            <input onclick="convert(0)" type="button" value="转化为简体" class="mybtn">
                            <input onclick="convert(1)" type="button" value="转化为繁体" class="mybtn">
                            <input onclick="copy('txt')" type="button" value="复制" class="mybtn">
                            <input onclick="cut('txt')" type="button" value="剪切" class="mybtn">
                            <input onclick="txt.value=''" type="button" value="清空" class="mybtn">&nbsp;&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
