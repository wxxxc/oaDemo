<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wdjh.aspx.cs" Inherits="hkpro.oa.jhgl.Wdjh" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <input type="button" name="AddBtn" value="增加" class="mybtn" onclick="javascript: popAdd('wdjh_add.aspx');" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="总体目标">
                                            ...
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('wdjh_mod.aspx?id=<%# Eval("jhid") %>')" class="gvlink">
