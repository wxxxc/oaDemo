<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ztdbrw.aspx.cs" Inherits="hkpro.oa.rwgl.ztdbrw" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="line-height: 40px;">
                            <div class="col-12">
                                ...
                                <asp:Button CssClass="btn btn-success" ID="UseBtn" runat="server" Text="重新发布" OnClick="Use_Click"
                                    OnClientClick="return confirm('确认要重新发布任务吗？')"></asp:Button>
                                <asp:Button CssClass="btn btn-primary" ID="StopBtn" runat="server" Text="任务暂停" OnClick="Stop_Click"
                                    OnClientClick="return confirm('暂停后的任务可以重新发布，确认继续吗？')"></asp:Button>
                                <asp:Button CssClass="btn btn-danger" ID="EndBtn" runat="server" Text="任务关闭" OnClick="End_Click"
                                    OnClientClick="return confirm('关闭后的任务将不能再发布，确认继续吗？')"></asp:Button>
                                <span>紧急程度：</span>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <HeaderTemplate>
                                                            <input id="chkall" type="checkbox" onclick="chkAll();" title="全选或全不选" class="mybox" style="width: 16; height: 16" />
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="任务标题">
                                                        <ItemTemplate>
                                                            <a href="#" onclick="javascript:popView('qxdbrw_yhview.aspx?rwid=<%# Eval("rwid") %>')"
