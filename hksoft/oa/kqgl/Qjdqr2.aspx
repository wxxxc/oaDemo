<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qjdqr2.aspx.cs" Inherits="hkpro.oa.kqgl.Qjdqr2" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_n.gif)"
                                align="center">
                                <a href="Qjdqr.aspx" class="black">待确认记录</a>
                            </td>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                                align="center">
                                <a href="Qjdqr2.aspx" class="mail_top">已确认记录</a>
                            </td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="请假人">
                                <ItemTemplate>
                                    <a href="#" onclick="javascript:popView('Qjdqr2_View.aspx?id=<%# Eval("ssqid") %>')"
                                        class="gvlink">
