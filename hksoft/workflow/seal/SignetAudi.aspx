<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignetAudi.aspx.cs" Inherits="hkpro.workflow.seal.SignetAudi" %>
                        ...
                        <tr>
                            <td style="height: 20px; width: 168;">
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td align="center" style="width: 84; height: 20; background-image: url(../../images/flow/sheety.jpg)">未审批
                                        </td>
                                        <td align="center" style="width: 84; background-image: url(../../images/flow/sheetn.jpg)">
                                            <a href="SignetAudiA.aspx" class="black">已审批</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRow_Bound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="相关操作">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <a href="#" class="gvlink" onclick="javascript:location.href='SignetAudi_Do.aspx?id=<%# Eval("sID") %>'">审批 </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
