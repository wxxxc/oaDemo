<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shdbrw.aspx.cs" Inherits="hksoft.app.task.shdbrw" %>
                ...
                <asp:UpdatePanel runat="server" ID="up1">
                    <ContentTemplate>
                        <asp:ListView ID="ListView1" runat="server">
                            <ItemTemplate>
                                <li class="list-group-item">
                                    <a href="shdbrw_a_show.aspx?rwid=<%#Eval("rwid")%>" data-ajax="false">
                                        <h4 class="listtitle">
                        ...
                        <webdiyer:AspNetPager ID="AspNetPager1" runat="server" OnPageChanged="AspNetPager1_PageChanged"
                            ...
                            PrevPageText="上页" CustomInfoSectionWidth="180px" CssClass="pagination" ShowBoxThreshold="5"
                            ...
                            ShowPageIndexBox="Never" ShowMoreButtons="false" ShowPageIndex="false" PageSize="5" style="padding-bottom:6px;">
