<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kqsmlr_Mod.aspx.cs" Inherits="hkpro.oa.kqgl.Kqsmlr_Mod" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="td_base" style="height: 25px">
                    ...
                    <asp:Button CssClass="mybtn" ID="DelJhBtn" runat="server" Text="删除" OnClick="DelJh_Click"
                        OnClientClick="return confirm('确认要删除该张考勤说明吗？')" Visible="false"></asp:Button>
            ...
            <tr>
                <td colspan="2" valign="top" align="center">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form">
                        ...
                        <tr>
                            <td class="form-item" rowspan="2">说明附件：
                            </td>
                            <td colspan="3">
                        ...
                        <asp:Panel ID="p_jsr" runat="server" Visible="false">
                            <tr>
                                <td class="form-item">
                        ...
                        <tr>
                            <td colspan="4" style="height: 25">下一步审批人：<asp:Label ID="lblspr" runat="server" Font-Bold="true"></asp:Label>
                                送审时间：<asp:Label ID="lblsssj" runat="server" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="jsr"
