<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wdyjx_f.aspx.cs" Inherits="hkpro.portal.xzgl.Wdyjx_f" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="98%">
                        <tr>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_n.gif)"
                                align="center">
                                <a href="Wdyjx.aspx" class="black">收到的意见</a>
                            </td>
                            <td style="width: 91px; background-image: url(../../images/tab_b_y.gif)" align="center">
                                <a href="Wdyjx_f.aspx" class="mail_top">发出的意见</a>
                            </td>
                            <td align="right">&nbsp;
                            </td>
                        </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" border="0" class="form">
                        <tr>
                            <td style="height: 40px">检索主题：<asp:DropDownList ID="tj" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Select_Click">
                                ...
                                <asp:ListItem Value="待回复" Text="待回复的意见"></asp:ListItem>
                                <asp:ListItem Value="已回复" Text="已回复的意见"></asp:ListItem>
                            </asp:DropDownList>
                            </td>
                            <td align="right">
                                <input type="button" id="AddBtn" name="AddBtn" value="发表意见" class="mybtn" onclick="javascript: popAdd('Wdyjx_f_Add.aspx');"
                                    runat="server" />
                            </td>
                        </tr>
                    </table>
                    ...
                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="意见标题">
                                <ItemTemplate>
                                    <a href="#" onclick="javascript:popMod('wdyjx_f_view.aspx?id=<%# Eval("yjid") %>')"
                                        class="gvlink">
                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("yjbt") %>'></asp:Label></a>
                                </ItemTemplate>
                                 <HeaderStyle CssClass="mwp50" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="mc" HeaderText="意见箱">
                                 <HeaderStyle CssClass="mw150" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ui_desc" HeaderText="管理人">
                                 <HeaderStyle CssClass="mw150" />
                            </asp:BoundField>
