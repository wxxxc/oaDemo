<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zwwh_Mod.aspx.cs" Inherits="hkpro.portal.bmgl.Zwwh_Mod" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2" align="center" style="height: 30">
                ...
                <input type="button" name="BackBtn" value="关 闭" class="btn btn-warning" onclick="javascript:window.close()" />
            </td>
        </tr>
    </table>
