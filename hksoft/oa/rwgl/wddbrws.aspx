<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wddbrws.aspx.cs" Inherits="hkpro.oa.rwgl.wddbrws" %>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs rwgl_nav" role="tablist" style="float: left;">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="wddbrws.aspx">送审中任务</a> </li>
                                    <li class="nav-item"><a class="nav-link" href="wddbrwj.aspx">已办结任务</a> </li>
                                </ul>
                                <div style="float: left; line-height: 40px;">
                                    &nbsp;<asp:Label ID="lblfbr" runat="server" Text="发布人:" Visible="false"></asp:Label><asp:TextBox
                                        ID="rysq" runat="server" CssClass="" Width="60" Visible="false" />
                                    ...
                                    <asp:TextBox ID="rwbt" runat="server" CssClass="" Width="100" Height="30" />
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="任务标题">
                                                <ItemTemplate>
                                                    <a href="#" onclick="javascript:popView('ssdbrw_yhview.aspx?rwid=<%# Eval("rwid") %>&jszt=<%# Eval("jszt")%>&jsid=<%# Eval("jsid") %>&type=ssz')"
