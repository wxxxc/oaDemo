<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormClass_Mod.aspx.cs"
    Inherits="hkpro.workflow.form.FormClass_Mod" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">     
        ...
        <tr>
            <td style="height: 30px" align="center">
                ...
                <input type="button" name="BackBtn" value=" 返回 " class="btn btn-info" onclick="javascript:location.href='FormClass.aspx';" />
            </td>
        </tr>
    </table>
