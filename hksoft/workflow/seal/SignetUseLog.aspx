<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignetUseLog.aspx.cs" Inherits="hkpro.workflow.seal.SignetUseLog" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td style="height: 38px">&nbsp;印章名称：<asp:TextBox ID="jsName" runat="server" CssClass="mytext" Width="150"></asp:TextBox>
                    时间：<asp:TextBox ID="jsUsetime" runat="server" CssClass="mytext" Width="150" onfocus="calendar();"></asp:TextBox>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="选择">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "slName") %>'
                                        Visible="False" Width="0px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="slName" HeaderText="印章名称"></asp:BoundField>
                            <asp:BoundField DataField="ui_desc" HeaderText="使用人"></asp:BoundField>
                            <asp:BoundField DataField="slIP" HeaderText="IP地址"></asp:BoundField>
                            <asp:BoundField DataField="UseTime" HeaderText="使用时间"></asp:BoundField>
                        </Columns>
