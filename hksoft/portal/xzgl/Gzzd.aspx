<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gzzd.aspx.cs" Inherits="hkpro.portal.xzgl.Gzzd" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <input type="button" id="AddBtn" name="AddBtn" value="增 加" class="mybtn" onclick="javascript: popView('gzzd_add.aspx');"
                                    runat="server" />
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="标题">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popView('gzzd_mod.aspx?id=<%# Eval("zdid") %>')"
                                                    class="gvlink">
