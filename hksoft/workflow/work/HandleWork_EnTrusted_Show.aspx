<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HandleWork_EnTrusted_Show.aspx.cs"
    Inherits="hkpro.workflow.work.HandleWork_EnTrusted_Show" ValidateRequest="false" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
            ...
            <td valign="top" align="center" colspan="2">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lbluName" runat="server" Width="90%"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="center" colspan="2" height="30">
                <input type="button" name="RecBtn" value=" 返回 " class="mybtn" onclick="javascript:location.href='HandleWork_EnTrusted.aspx'" />
            </td>
        </tr>
    </table>
