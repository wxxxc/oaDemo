<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dbrwybj_a.aspx.cs" Inherits="hksoft.app.task.dbrwybj_a" %>
                            ...
                            <ItemTemplate>
                                <li class="list-group-item">
                                    ...
                                    <asp:Label ID="Label14" runat="server" Text='<%# Eval("source") %>' Font-Bold="true" />--%>
                                            <asp:Label ID="Label15" runat="server" Text='<%# Eval("rwbt").ToString().Length>17?Eval("rwbt").ToString().Substring(0,17)+"…":Eval("rwbt").ToString() %>' Font-Bold="true" />
                                        ...
                                        <div class="info">
                                            ...
                                            <asp:Label ID="Label18" runat="server" Text='<%# Eval("fbsj", "{0:MM/dd HH:mm}") %>' ForeColor="Gray"
                                                Font-Size="Small" />
                                        </div>
                                        <div style="clear: both;"></div>
                                    </a>
