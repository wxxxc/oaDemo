<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kqsmcx.aspx.cs" Inherits="hkpro.oa.kqgl.Kqsmcx" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="申请人">
                                        ...
                                        <ItemTemplate>
                                            <a href="#" onclick="javascript:popView('Kqsmcx_View.aspx?id=<%# Eval("sid") %>')"
                                                class="gvlink">
                                                <asp:Label ID="Labelyjje" runat="server" Text='<%# Bind("sqrmc") %>'></asp:Label></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="qdsj" HeaderText="日期" DataFormatString="{0:yyyy-MM-dd}"
                                        HtmlEncode="False">
                                    ...
                                    <asp:BoundField DataField="kqqksm" HeaderText="考勤情况说明">
