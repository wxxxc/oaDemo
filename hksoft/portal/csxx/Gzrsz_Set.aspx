                ...
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1">
                    <tr>
                        ...
                        <td align="right" style="height: 40">
                            ...
                            <asp:Button ID="btnsubmit" runat="server" Text="保 存" CssClass="btn btn-success" OnClick="btnsubmit_Click">
                            </asp:Button>
                            <input type="button" name="RecBtn" value="返 回" class="btn btn-info" onclick="javascript:location.href='Gzrsz.aspx'" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
