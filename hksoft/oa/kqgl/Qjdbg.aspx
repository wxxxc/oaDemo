<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qjdbg.aspx.cs" Inherits="hkpro.oa.kqgl.Qjdbg" %>
                ...
                <td>
                    <table cellspacing="0" cellpadding="2" width="800" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="qjzt" runat="server" Width="150" Enabled="false">
                                    <asp:ListItem Text="" Value=""></asp:ListItem>
                                    ...
                                    <asp:ListItem Text="已确认" Value="已确认" Selected="True"></asp:ListItem>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="请假人">
                                            ...
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popView('Qjdbg_View.aspx?id=<%# Eval("qid") %>')"
                                                    class="gvlink">
