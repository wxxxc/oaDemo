<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ygtxl_lb_add.aspx.cs" Inherits="hkpro.portal.xzgl.Ygtxl_lb_add" %>
        ...
        <table class="form" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td colspan="4" align="center">
                    <asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="保存并新增类别" />
