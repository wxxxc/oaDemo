<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseUser_WorkRole.aspx.cs"
    Inherits="hkpro.Choose_A.flow.ChooseUser_WorkRole" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>选择用户(按角色)</title>
    <base target="_self" />
    ...
    <script language="javascript">
        ...
        function sendFromChild() {
            window.opener.setValue_workrole(CheckSelect());
            window.close();
        }

        function clearwin() {
            window.opener.setValue_workrole("|");
            window.close();
        }
