<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlow_Mod.aspx.cs" Inherits="hkpro.workflow.flow.WorkFlow_Mod" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td valign="top" align="center" colspan="2">
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="FileNo" runat="server" Width="90%" CssClass="mytext"></asp:TextBox>
        ...
        <tr>
            <td align="center" colspan="2" height="30">
                <asp:Button ID="SaveBtn" runat="server" Text=" 提交 " CssClass="btn btn-primary" OnClick="SaveBtn_Click" />
                <input id="CloseBtn" class="btn btn-danger" onclick="javascript:window.close()" type="button"
                    value=" 关闭 " />
            </td>
        </tr>
    </table>
    <asp:TextBox ID="wfUserIDs" runat="server" Width="90%" Style="display: none"></asp:TextBox>
