<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yddhview.aspx.cs" Inherits="hkpro.Choose.portal.Yddhview" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    <title>选择接收号码（通过勾选最前面的方框完成选择）</title>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            <td colspan="2" style="height: 20">
                                <font color="red">提示：只显示登记了移动电话的用户。</font>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                关键字搜索：<asp:DropDownList ID="query_tj" runat="server">
                                    ...
                                    <asp:ListItem Value="ui_yddh">移动电话</asp:ListItem>
                                </asp:DropDownList>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <input style="width: 16; height: 16" name="chk" id="<%# Eval("ui_yddh") %>" title="选择或取消"
                                                    type="checkbox" onclick="javascript:clickemail('<%# Eval("ui_yddh") %>');" />
                                            </ItemTemplate>
