<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bmjh.aspx.cs" Inherits="hkpro.oa.jhgl.Bmjh" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="总体目标">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('bmjh_mod.aspx?id=<%# Eval("jhid") %>')" class="gvlink">
