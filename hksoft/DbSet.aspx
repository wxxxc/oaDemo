<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DbSet.aspx.cs" Inherits="hkpro.DbSet" %>
                            ...
                            <td align="center">
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="98%">
                                    <tr>
                                        ...
                                        <td style="width: 91px; background-image: url(images/tab_b_y.gif)" align="center">
                                            <a href="dbset.aspx" class="mail_top">自定义驾驶舱</a>
                                        </td>
                                        <td>&nbsp;
                                        </td>
                                        <td align="right">
                                            <input type="button" name="AddBtn" value="增 加" class="mybtn" onclick="javascript: popAdd('dbset_view.aspx');" />
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="Item_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="数据项">
                                            <ItemTemplate>
