...
{
    public partial class Bmnjmx : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        public void BindGrid()
        {
            ...
            ReportDataSource rds = new ReportDataSource("Bmnjmx_ds_DataTable1", dt);
        ...
        public DataTable ReportBind()
        {
            ...
            DataSet ds = SqlHelper.ExecuteDs("EXEC sp_OA_KQ_BMNJMX '" + strNd_s + "','" + strNd_e + "','" + strJd_s + "','" + strJd_e + "','" + bm.SelectedValue + "','" + hkdb.GetStr(UserID1.Text) + "'");
