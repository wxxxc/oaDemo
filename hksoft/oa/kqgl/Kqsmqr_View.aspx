<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kqsmqr_View.aspx.cs" Inherits="hkpro.oa.kqgl.Kqsmqr_View" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="td_base" style="width: 80%; height: 25px">考勤说明确认
                </td>
                            ...
                            <td colspan="2">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                                    ...
                                    <tr style="height: 25px">
                                        ...
                                        <td colspan="3">
                                            <asp:CheckBox ID="xxtz" runat="server" Text="站内消息通知申请人" Checked="true" />
