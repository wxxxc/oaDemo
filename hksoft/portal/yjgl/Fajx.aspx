<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fajx.aspx.cs" Inherits="hkpro.portal.yjgl.Fajx" %>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 61px; background-image: url(../../images/tab_y.gif)" align="center">
                                            <a href="fajx.aspx" class="mail_top">发件箱</a>
                                        </td>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="标题">
                                            <ItemTemplate>
                                                <a href="Viewyj.aspx?type=f&id=<%# Eval("yjid") %>" class="gvlink">
