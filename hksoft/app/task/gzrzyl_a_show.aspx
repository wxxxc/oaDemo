<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gzrzyl_a_show.aspx.cs" Inherits="hksoft.app.task.gzrzyl_a_show" %>
        ...
        <div data-role="page" id="indexPage">
            ...
            <div class="hf_index">
                <div data-role="header" data-position="fixed" data-theme="d" style="border-bottom-color: white; background: #5295EE; height: 58px">
                    <a onclick="window.location='gzrz.aspx'" class="ui-btn-up-a  ui-btn" data-role="button" data-inline="true" style="border: none; background: #5295EE;" data-iconpos="left">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                                        ...
                                        <tr>
                                            <td class="form-item">日志人：
                                            </td>
                                            <td colspan="3">
                                                <asp:Label ID="rzr" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="form-item">所在部门：
                                            </td>
                                            <td colspan="3">
                                                <asp:Label ID="szbm" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
