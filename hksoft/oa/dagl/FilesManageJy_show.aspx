<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageJy_show.aspx.cs"
    Inherits="hkpro.oa.dagl.FilesManageJy_show" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="借阅">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="JieYue" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                    CommandName="JieYue" CssClass="gvlink">借阅</asp:LinkButton>
                                            </ItemTemplate>
