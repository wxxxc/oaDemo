<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rwview_dw.aspx.cs" Inherits="hksoft.choose.oa.rwview_dw" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <input style="width: 16; height: 16" name="chk" id="<%# Eval("name") %>" title="选择或取消"
                                                    type="checkbox" onclick="javascript:clickemail('<%# Eval("name") %>')" />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="charge" HeaderText="负责人">
