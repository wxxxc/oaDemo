                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            <td style="height: 40px">快速检索：<asp:DropDownList ID="query_tj" runat="server">
                                <asp:ListItem Value="qzmc" Selected="True">群组名称</asp:ListItem>
                                <asp:ListItem Value="qzsm">群组说明</asp:ListItem>
                                <asp:ListItem Value="qzlx">群组类型</asp:ListItem>
                                <asp:ListItem Value="qzcymc">组内成员</asp:ListItem>
                            </asp:DropDownList>
                            ...
                            <td align="right">
                                ...
                                <input type="button" name="AddBtn" value="增加" class="mybtn" onclick="javascript: popAdd('wdyhqz_view.aspx');" />
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    DataKeyNames="qzid" EmptyDataText="没有查到符合条件的数据！"  Width="99%" CssClass="table">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="qzid" HeaderText="编码">
                                        ...
                                        <asp:BoundField DataField="qzcymc" HeaderText="组内成员">
                                             <HeaderStyle CssClass="mwp20"  />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="qzlx" HeaderText="群组类型">
                                            <HeaderStyle Wrap="false" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="false" />
                                             <HeaderStyle CssClass="mwp20"  />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="qzsm" HeaderText="说明">
                                            <HeaderStyle Wrap="false" />
                                             <HeaderStyle CssClass="mwp20"  />
                                        </asp:BoundField>
