...
{
    public partial class FilesManageBook : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        public void GridViewBind()
        {
            ...
            AspNetPager1.RecordCount = (int)SqlHelper.ExecuteScalar("SELECT COUNT(*) AS NUMS FROM OA_FilesManageBook" + Str1);
