<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitorWork.aspx.cs" Inherits="hkpro.workflow.work.MonitorWork" %>
            ...
            <tr>
                <td>
                    <table cellspacing="1" cellpadding="0" width="100%" align="center" border="0">
                        ...
                        <tr>
                            <td colspan="2">&nbsp;表单类型：<asp:DropDownList ID="txt_fName" runat="server" Width="150px">
                            </asp:DropDownList>
                        ...
                        <tr>
                            <td colspan="2">&nbsp;工作文号：<asp:TextBox ID="Name" runat="server" Width="150px" CssClass="mytext"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="2">&nbsp;发起部门：<asp:DropDownList ID="fqbm" runat="server" Width="150px">
                            </asp:DropDownList>
                                ...
                                <input id="ClearBtn" type="button" value="清空" onclick="clearall()" class="btn btn-danger" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" height="5"></td>
                            ...
                            <td colspan="2">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRow_Bound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PromoterName" HeaderText="发起人">
                                        ...
                                        <asp:TemplateField HeaderText="流程操作">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblwSta" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "wStatus")%>'
                                                    Visible="false"></asp:Label>
