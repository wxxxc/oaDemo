<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryWork_Zf.aspx.cs" Inherits="hkpro.workflow.work.QueryWork_Zf" %>
...
<body class="main">
    ...
    <table align="center" border="0" cellpadding="4" cellspacing="0" width="100%" class="form">
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="xxtz" runat="server" Text="站内消息提醒转发人" Checked="true" />
                <asp:CheckBox ID="dxtz" runat="server" Text="手机短信提醒转发人" Checked="false" />
            </td>
        </tr>
        <tr>
