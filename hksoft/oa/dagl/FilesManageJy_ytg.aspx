<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageJy_ytg.aspx.cs"
    Inherits="hkpro.oa.dagl.FilesManageJy_ytg" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="98%" align="center">
                        <tr>
                            ...
                            <td style="width: 91px; background-image: url(../../images/tab_b_y.gif)" align="center">
                                <a href="FilesManageJy_ytg.aspx" class="mail_top">未归还</a>
                            </td>
                                        ...
                                        <asp:TemplateField HeaderText="归还">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="LJyUsername" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "JyUsername")%>'
                                                    Visible="false"></asp:Label>
                                                <asp:LinkButton ID="GuiHuan" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                    CommandName="GuiHuan" CssClass="gvlink">归还</asp:LinkButton>
                                            </ItemTemplate>
