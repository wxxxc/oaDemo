<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xmwh.aspx.cs" Inherits="hkpro.oa.xmgl.Xmwh" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <input type="button" name="AddBtn" value="增加" class="mybtn" onclick="javascript: popAdd('xmwh_view.aspx');" />
                                <asp:Button CssClass="mybtn" ID="DelBtn" runat="server" Text="删除" OnClientClick="return confirm('确认要执行删除吗？')"
                            ...
                            <td colspan="2">
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="xmid" HeaderText="序号">
                                            <HeaderStyle CssClass="hidden" />
                                            <ItemStyle CssClass="hidden" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="项目名称">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('xmwh_view.aspx?id=<%# Eval("xmid") %>')"
                                                    class="gvlink">
