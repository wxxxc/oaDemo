<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xmcx_Gzjl.aspx.cs" Inherits="hkpro.oa.xmgl.Xmcx_Gzjl" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="td_base" width="80%" height="25px">查看跟踪记录
                </td>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" align="center">
                                    <tr>
                                        ...
                                        <td style="width: 91px; background-image: url(../../images/tab_b_y.gif)" align="center">
                                            <a href="xmcx_gzjl.aspx?id=<%=xmid.Text %>" class="mail_top">跟踪记录</a>
                                        </td>
