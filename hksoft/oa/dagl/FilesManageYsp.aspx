<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageYsp.aspx.cs"
    Inherits="hkpro.oa.dagl.FilesManageYsp" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="98%" align="center">
                        <tr>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_n.gif)"
                                align="center">
                                <a href="FilesManageSp.aspx" class="black">未审批</a>
                            </td>
                            <td style="width: 91px; background-image: url(../../images/tab_b_y.gif)" align="center">
                                <a href="FilesManageYsp.aspx" class="mail_top">已审批</a>
                            </td>
                            <td align="right">&nbsp;
                            </td>
                        </tr>
