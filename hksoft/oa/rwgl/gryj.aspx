<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gryj.aspx.cs" Inherits="hksoft.oa.rwgl.gryj" %>
                        ...
                        <div class="row" style="line-height: 40px;">
                            <div class="col-12">
                                <div style="float: left; line-height: 40px;">
                                    ...
                                    <asp:Label runat="server" style="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共&nbsp;&nbsp;<p style="display:initial;color:red;font-size:18px;"><%=num %></p>&nbsp;&nbsp;条</asp:Label>
                                </div>
                            </div>
                        </div>
                    </div>
