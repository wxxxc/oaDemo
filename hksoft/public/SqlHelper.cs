...
namespace haoke365
{
    public class SqlHelper
    {
        ...
        {
            String conn = ConfigurationManager.AppSettings["haokeDataLink"].ToString();
            return conn;
        }
        #endregion
        ...
        /// <summary>  
        /// 执行SQL语句并返回DataSet，集成AspNetPager分页组件  
        /// </summary>  
        /// <param name="Sqlstr">SQL语句</param>
        /// <param name="startindex">开始记录数</param>
        /// <param name="num">总记录数</param>
        /// <returns></returns>  
        public static DataSet ExecuteDs(String Sqlstr, int startindex, int num)
        {
            String ConnStr = GetSqlConnection();
            using (SqlConnection conn = new SqlConnection(ConnStr))
            {
