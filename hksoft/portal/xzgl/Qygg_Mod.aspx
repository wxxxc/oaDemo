<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qygg_Mod.aspx.cs" Inherits="hkpro.portal.xzgl.Qygg_Mod"
    ...
    <script type="text/javascript">
        function Attyulan() {
            if (document.getElementById('fjlb').value == '') {
                ...
                window.open("<%=qy_fjylurl.Text %>Attach/portal/gg/"+cValue+"", "_blank");                 
                        ...
                        <td colspan="2">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:DropDownList ID="fjlb" runat="server" Width="85%" onchange="BindDpList1">
                                        </asp:DropDownList>
                                          <%--<a href="<%=qy_fjylurl.Text %>Attach/portal/gg/<%=Label1.Text %>" target="_blank" id="ff" onclick="Attyulan()">预览</a>--%>
                                        <span OnClick="Attyulan()" style="color:dodgerblue">预览</span>  
