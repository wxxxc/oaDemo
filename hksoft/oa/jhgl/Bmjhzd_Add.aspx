<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bmjhzd_Add.aspx.cs" Inherits="hkpro.oa.jhgl.Bmjhzd_Add" %>
...
<body class="main">
    <form id="form1" runat="server">
            ...
            <tr>
                <td colspan="2" valign="top" align="center">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form">
                        ...
                        <tr>
                            <td class="form-item">
                                <font color="red">*</font>选择部门：
                            </td>
                            <td>
                                <asp:DropDownList ID="bm" runat="server" Width="90%">
                                </asp:DropDownList>
                            </td>
                            <td></td>
                            <td></td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="工作主题">
                                    <ItemTemplate>
                                        <a href="#" onclick="javascript:popView('bmjh_gzx_mod.aspx?type=a&id=<%# Eval("id") %>&jhid=<%# Eval("jhid") %>')"
                                            class="gvlink">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="bm"
            ErrorMessage="请选择部门">&nbsp;
        </asp:RequiredFieldValidator>
