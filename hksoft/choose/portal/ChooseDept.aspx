<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseDept.aspx.cs" Inherits="hkpro.Choose.portal.ChooseDept" %>
    ...
    <script language="javascript">
        ...
        function sendFromChild() {
            ...
            if (bstr == '3' | bstr == '4' | bstr == '5') {
                window.opener.setValue_bm(CheckSelect());
            }
            else {
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
        ...
        <tr>
            <td style="height: 20px;" align="center" colspan="3">
                <input id="SaveBtn" class="mybtn" onclick="return checkbtn();" type="button"
                    value=" 确定 " />
