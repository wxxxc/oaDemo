<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zsqltj.aspx.cs" Inherits="hkpro.oa.zsgl.zsqltj" %>
                            ...
                            <td colspan="2">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRow_Bound" DataKeyNames="id"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TjTime" HeaderText="强力推荐时间" DataFormatString="{0:yyyy-MM-dd HH:mm}"
                                            HtmlEncode="False">
                                            <ItemStyle HorizontalAlign="Center" />
