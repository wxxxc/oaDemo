...
{
    public partial class MySignet : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        {
            string Str1 = " WHERE sUser='" + this.Session["userid"] + "'";
            ...
            DataSet ds = SqlHelper.ExecuteDs("SELECT * FROM hk_Seal" + Str1, AspNetPager1.PageSize * (AspNetPager1.CurrentPageIndex - 1), AspNetPager1.PageSize);
        ...
        {
            mydb.Goto("MySignet_Mod.aspx?id=" + chkChoose() + "");
        }
        ...
        protected void Del_Click(object sender, EventArgs e)
        {
            ...
            SqlHelper.ExecuteSql("DELETE FROM hk_Seal WHERE sID IN(" + chkStr + ")");
            mydb.Alert("删除成功！");
