<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qjdsp2.aspx.cs" Inherits="hkpro.oa.kqgl.Qjdsp2" %>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_n.gif)"
                            align="center">
                            <a href="Qjdsp.aspx" class="black">待审批记录</a>
                        </td>
                        <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                            align="center">
                            <a href="Qjdsp2.aspx" class="mail_top">已审批记录</a>
                        </td>
                        <td align="right">
                            请假类型：<asp:DropDownList ID="qjlx" runat="server">
                            ...
                            <asp:Button CssClass="mybtn" ID="Button1" runat="server" Text="查 询" OnClick="Receive_Click">
                            </asp:Button>
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="请假人">
                            <ItemTemplate>
                                <a href="#" onclick="javascript:popView('Qjdsp2_View.aspx?id=<%# Eval("ssqid") %>')"
                                    class="gvlink">
