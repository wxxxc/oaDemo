<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yfsdx.aspx.cs" Inherits="hkpro.portal.dxgl.Yfsdx" %>
                            ...
                            <td colspan="2">
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                                            align="center">
                                            <a href="yfsdx.aspx" class="mail_top">已发送短信</a>
                                        </td>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ssendno" HeaderText="接收号码">  <HeaderStyle CssClass="mwp30" /></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="nIsSend" HeaderText="状态">
                                            <HeaderStyle CssClass="mw60" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="dTimingTime" HeaderText="发送时间" DataFormatString="{0:yy-MM-dd HH:mm:ss}"
                                            HtmlEncode="False">
