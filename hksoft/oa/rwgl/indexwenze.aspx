<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexwenze.aspx.cs" Inherits="hksoft.oa.rwgl.indexwenze" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="height: 25px;" class="td_base">查看[<asp:Label ID="rwdh" runat="server" ForeColor="yellow"></asp:Label>]被问责任务
                </td>
            </tr>
            <tr>
                <td>
