<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zszj_update.aspx.cs" Inherits="hkpro.oa.zsgl.zszj_update"
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td colspan="2" valign="top">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="fjlb" runat="server" Width="480px">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="uploadFile" runat="server" style="width: 480" type="file" name="uploadFile"
                                class="mytext" />
        ...
        <tr>
            <td colspan="2" align="center" style="height: 30">
                <asp:Button ID="BtnS" runat="server" Text="保存并关闭" class="mybtn" OnClick="BtnS_Click" />
