<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qjdlr_Mod.aspx.cs" Inherits="hkpro.oa.kqgl.Qjdlr_Mod" %>
...
<body class="main">
    <form id="form1" runat="server">
            ...
            <tr>
                <td class="td_base" style="height: 25px">
                    ...
                    <asp:Button CssClass="mybtn" ID="DelJhBtn" runat="server" Text="删除" OnClick="DelJh_Click"
                        OnClientClick="return confirm('确认要删除该张请假单吗？')" Visible="false"></asp:Button>
            ...
            <tr>
                <td colspan="2" valign="top" align="center">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form">
                        ...
                        <tr>
                            <td class="form-item" style="width: 20%">实际请假天数：
                            </td>
                            <td style="width: 30%">
                        ...
                        <tr>
                            <td class="form-item" rowspan="2">请假附件：
                            </td>
                            <td colspan="3">
        ...
        <!--隐藏label-->
        <asp:Label ID="qjzt" runat="server" Visible="false" />
