...
(function ($) {
    ...
    _listen = function () {
        ...
        $('body').on('shown.bs.tab', 'a[data-toggle="tab"]', function () {
            ...
            $("#bread_crumb_title_li").text($(this).parent('li').text());
        });
    ...
    $.addtabs.add = function (opts) {
        ...
        if (settings.store) {
          var tabs = _store('addtabs'+settings.storeName) ? $.parseJSON(_store('addtabs'+settings.storeName)) : {};
            ...
            tabs[id].active = 'true';
            //if (tabs[id]) {
            //    var show_title = "<div class='tab_title_show'>" + tabs[id].title + "</div>";
            //    $("#bread_crumb_title_li").text($(show_title).text());
            //}
            tabs = JSON.stringify(tabs);
            _store('addtabs' + settings.storeName, tabs);
        }
    ...
    $.addtabs.close = function (opts) {
        ...
        if ($("#tab_" + opts.id).hasClass('active')) {
            ...
            $("#bread_crumb_title_li").text($("#tab_" + opts.id).prev().text());
        }
        //关闭TAB
        $("#tab_" + opts.id).remove();
        $("#" + opts.id).remove();
