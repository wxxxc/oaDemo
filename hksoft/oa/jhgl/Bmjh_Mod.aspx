<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bmjh_Mod.aspx.cs" Inherits="hkpro.oa.jhgl.Bmjh_Mod" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form">
                        ...
                        <asp:Panel ID="zgpjpanel" runat="server" Visible="false">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="zgpjnr" runat="server" CssClass="mytextarea" Width="90%" ReadOnly="true"
                                        TextMode="multiLine" Rows="2"></asp:TextBox>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="工作主题">
                                    <ItemTemplate>
                                        <a href="#" onclick="javascript:popView('bmjh_gzx.aspx?id=<%# Eval("id") %>')" class="gvlink">
