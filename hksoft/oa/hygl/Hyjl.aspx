<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hyjl.aspx.cs" Inherits="hkpro.oa.hygl.Hyjl" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="编码">
                                            ...
                                            <ItemStyle HorizontalAlign="center" />
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('hyjl_view.aspx?id=<%# Eval("id") %>')" class="gvlink">
