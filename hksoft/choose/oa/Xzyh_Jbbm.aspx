<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xzyh_Jbbm.aspx.cs" Inherits="hksoft.choose.oa.Xzyh_Jbbm" %>
    ...
    <script language="javascript">
        ...
        function sendFromChild() {
            ...
            if (bstr == '3' | bstr == '4' | bstr == '5') {
                window.opener.setValue_unit(chkSelect());
            }
            else {
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
                        <tr>
                            <td style="height: 30px; text-align: center;">
                                <asp:TextBox ID="KeyBox" runat="server" Style="display: none" CssClass="mytext"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 302px">
                                    <tr>
                                        <td align="center" style="width: 113px" valign="top">
                                            <asp:ListBox ID="SourceListBox" runat="server" Height="411px" Width="157px"></asp:ListBox>
                                        </td>
                                        ...
                                        <td align="center" style="width: 100px" valign="top">
                                            <asp:ListBox ID="TargetListBox" runat="server" Height="411px" Width="157px"></asp:ListBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td style="height: 30px; text-align: center;">
                                <input id="Button2" class="mybtn" onclick="return checkbtn();" type="button" value="确定" />
                                <input type="button" value="关闭" onclick="closewin();" class="mybtn" id="Button3" />
                                <input id="Button12" class="mybtn" onclick="clearwin();" type="button" value="清空" />
                            </td>
                        </tr>
                    </table>
                </td>
