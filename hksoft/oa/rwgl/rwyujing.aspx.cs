...
{
    public partial class rwyujing : System.Web.UI.Page
    {
        ...
        {
            string Str1 = "where b.jszt='未接收' and a.fbsj+1<GETDATE() and a.rwzt='已发布'";
            //if (!string.IsNullOrEmpty(query_content.Text))
            //{
            //    if (query_content.Text == "cs")
            //    {
            //        Str1 = " where  b.jszt='未接收' and a.ynxs='是' and a.jzrq<GETDATE()";
            //    }
            //    else
            //    {
            //        Str1 = "where b.jszt='未接收'  and a.ynxs='否' and a.fbsj+1<GETDATE()";
            //    }

            //}
            //else {
            //    Str1 = " where (b.jszt='未接收' and a.fbsj+1<GETDATE() or (b.jszt='未接收' and a.ynxs='是' and a.jzrq<GETDATE()))";
            //}
        ...
        {
            string Str1 = "where  b.jszt!='已办结' and a.ynxs='是' and a.jzrq<GETDATE() ";
