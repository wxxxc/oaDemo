<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cshmm_Gys.aspx.cs" Inherits="hkpro.portal.yhgl.Cshmm_Gys" %>
...
<body class="main">
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="98%">
                    <tr>
                        ...
                        <td style="width: 91px; background-image: url(../../images/tab_b_y.gif)" align="center">
                            <a href="Cshmm_Gys.aspx" class="mail_top">供应商密码</a>
                        </td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="yhid"
        ErrorMessage="请输入供应商编码">&nbsp; </asp:RequiredFieldValidator>
