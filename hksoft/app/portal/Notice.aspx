<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice.aspx.cs" Inherits="hkpro.app.portal.Notice" %>
                ...
                <asp:UpdatePanel runat="server" ID="up1">
                    <ContentTemplate>
                        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ggid">
                            <ItemTemplate>
                                <li class="list-group-item" style="margin-bottom: 22px;">
                                    <a href="Notice_Show.aspx?id=<%# Eval("ggid") %>">
                                        <h4 class="listtitle">
                                            <asp:Label ID="lblzt" runat="server" Text='<%# Eval("ggzt").ToString().Length>17?Eval("ggzt").ToString().Substring(0,17)+"…":Eval("ggzt").ToString()%>' /></h4>
                                        <div class="info">
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("lrrmc") %>' />
                                        </div>
                                        <div style="clear: both;"></div>
                                        <div class="info">
                                            <asp:Label ID="lblspsj" runat="server" Text='<%# Bind("lrsj", "{0:yyyy-MM-dd HH:mm}") %>' />
                                        </div>
                                        <div style="clear: both;"></div>
                                    </a>
                                </li>
                        ...
                        <div class="size_list">
                            <webdiyer:AspNetPager ID="AspNetPager1" runat="server" OnPageChanged="AspNetPager1_PageChanged"
                                ...
                                NextPageText="下页"
                                PrevPageText="上页"
                                CustomInfoSectionWidth="180px"
                                CssClass="pagination"
                                ShowBoxThreshold="5"
                                InputBoxClass="pagetext"
                                SubmitButtonClass="pagebtn"
                                SubmitButtonText="转到" LayoutType="Ul"
                                PagingButtonSpacing="0"
                                CurrentPageButtonClass="active"
                                ShowPageIndexBox="Never"
                                ShowMoreButtons="false" ShowPageIndex="false" PageSize="5">
