<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dwml.aspx.cs" Inherits="hkpro.portal.xzgl.Dwml" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" border="0">
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <input type="button" id="AddBtn" name="AddBtn" value="增加" class="mybtn" onclick="javascript: popAdd('dwml_add.aspx');"
                                    runat="server" />
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="单位名称">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('dwml_mod.aspx?id=<%# Eval("id") %>')" class="gvlink">
