<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rwview1.aspx.cs" Inherits="hksoft.app.choose_a.fdrw.rwview_dw" %>
        ...
        <div data-role="page" id="indexPage" class="cum_index">
            <div class="hf_index">
                <div data-role="header" data-position="fixed" data-theme="b" style="border-bottom-color: white; background: #5295EE; height: 58px">
                    <h1 style="font-weight: 100; color: white; font-size: 18px; text-shadow: none; margin: 1em 30% 0.8em;">选择牵头领导</h1>
