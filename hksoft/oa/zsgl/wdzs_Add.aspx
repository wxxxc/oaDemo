<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wdzs_Add.aspx.cs" Inherits="hkpro.oa.zsgl.wdzs_Add" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="td_base" width="80%" height="25px">
                <asp:Label ID="lbltitle" runat="server"></asp:Label>知识
            </td>
        ...
        <tr>
            <td colspan="2" align="center" style="height: 30">
                ...
                <asp:Button CssClass="mybtn" ID="SANZJ" runat="server" Text="下一步新建章节" OnClick="SANZJ_Click"
                    Style="width: 110"></asp:Button>
