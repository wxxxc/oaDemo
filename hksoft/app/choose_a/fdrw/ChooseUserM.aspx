<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseUserM.aspx.cs" Inherits="hksoft.choose_a.fdrw.ChooseUserM" %>
        ...
        <div data-role="page" id="indexPage" class="cum_index">
            <div class="hf_index">
                <div data-role="header" data-position="fixed" data-theme="b" style="border-bottom-color: white; background: #5295EE; height: 58px">
                    <h1 style="font-weight: 100; color: white; font-size: 18px; text-shadow: none; margin: 1em 30% 0.8em;">选择接收人</h1>
                    ...
                    <ItemTemplate>
                        <li>
                            <table>
                                <tr>
                                    <td>
                                        <input name="chk" id="<%# Eval("ui_id") %>" type="checkbox" onclick="javascript:clickemail('<%# Eval("ui_id").ToString()%>');" data-role="none" class="input_check" />
                                    </td>
                                    <td>
                                        <h3 class="listtitle">
