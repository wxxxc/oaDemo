<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dbrwssz_a.aspx.cs" Inherits="hksoft.app.task.dbrwssz_a" %>
                            ...
                            <ItemTemplate>
                                <li class="list-group-item">
                                    ...
                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("source") %>' Font-Bold="true" />--%>
                                            <asp:Label ID="Label9" runat="server" Text='<%# Eval("rwbt").ToString().Length>17?Eval("rwbt").ToString().Substring(0,17)+"…":Eval("rwbt").ToString() %>' Font-Bold="true" />
                                        ...
                                        <div class="info">
                                            ...
                                            <asp:Label ID="Label12" runat="server" Text='<%# Eval("fbsj", "{0:MM/dd HH:mm}") %>' ForeColor="Gray"
                                                Font-Size="Small" />
                                        </div>
                                        <div style="clear: both;"></div>
                                    </a>
