<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cshmm_Yz.aspx.cs" Inherits="hkpro.portal.yhgl.Cshmm_Yz" %>
...
<body class="main">
            ...
            <td align="center">
                <table cellspacing="0" cellpadding="0" border="0" width="98%">
                    <tr>
                        ...
                        <td style="width: 91px; background-image: url(../../images/tab_b_y.gif)" align="center">
                            <a href="Cshmm_Yz.aspx" class="mail_top">业主密码</a>
                        </td>
                        <td style="width: 91px; background-image: url(../../images/tab_b_n.gif)" align="center">
                ...
                <table cellspacing="0" cellpadding="0" width="98%" border="0" class="form">
                    <tr>
                        ...
                        <td style="width: 30%">
                            <asp:TextBox CssClass="mytext" ID="yzid" runat="server" Width="90%" MaxLength="20"
                                AutoPostBack="true" OnTextChanged="yzid_TextChanged"></asp:TextBox>
                        </td>
                        <td class="form-item" style="width: 20%">
                            业主名称：
                        </td>
                        <td style="width: 30%">
                            <asp:Label ID="lblyzmc" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="form-item">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="yzid"
        ErrorMessage="请输入业主编码">&nbsp; </asp:RequiredFieldValidator>
