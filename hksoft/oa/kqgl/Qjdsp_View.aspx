<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qjdsp_View.aspx.cs" Inherits="hkpro.oa.kqgl.Qjdsp_View" %>
...
<body class="main">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tr>
                        <td colspan="2" align="center" style="height: 30">
                            <asp:Button CssClass="mybtn" ID="PassBtn" runat="server" Text="审批通过" OnClick="Pass_Click">
                            </asp:Button>
    ...
    <asp:Label ID="qidstr" runat="server" Visible="False"></asp:Label>
