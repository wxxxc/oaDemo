...
{
    public partial class indexshview : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        public void GridViewBind()
        {
            ...
            DataSet ds = SqlHelper.ExecuteDs("select a.spyj,a.spsj,a.jsid,a.jszt,a.clsj,a.bzsm,a.fjlj,a.fjmc,a.fpxs,a.fpsm,case when(a.fjmc=''or a.fjmc is null) then 'n' else 'down' end as fjmc2,b.ui_desc from OA_RWD02 a left outer join yh b on (a.jsr=b.ui_id)" + Str1 + "order by jssj desc");
