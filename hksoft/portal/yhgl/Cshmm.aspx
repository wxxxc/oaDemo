<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cshmm.aspx.cs" Inherits="hkpro.portal.yhgl.Cshmm" %>
...
<body class="main">
            ...
            <td align="center">
                <table cellspacing="0" cellpadding="0" border="0" width="98%">
                    <tr>
                        <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                            align="center">
                            <a href="Cshmm.aspx?i=2" class="mail_top">用户密码</a>
                        </td>
                        ...
                        <asp:Panel ID="p_pms" runat="server" Visible="false">
                            <td style="width: 91px; background-image: url(../../images/tab_b_n.gif)" align="center">
                                <a href="Cshmm_Yz.aspx" class="black">业主密码</a>
                            </td>
                            <td style="width: 91px; background-image: url(../../images/tab_b_n.gif)" align="center">
                                <a href="Cshmm_Zh.aspx" class="black">租户密码</a>
                            </td>
                        </asp:Panel>
                        <td>
                            &nbsp;
                ...
                <table cellspacing="0" cellpadding="0" width="98%" border="0" class="form">
                    <tr>
                        ...
                        <td style="width: 30%">
                            <asp:TextBox CssClass="mytext" ID="yhid" runat="server" Width="90%" MaxLength="20"
                                AutoPostBack="true" OnTextChanged="yhid_TextChanged"></asp:TextBox>
                        </td>
                        <td class="form-item" style="width: 20%">
                            用户姓名：
                        </td>
                        <td style="width: 30%">
                            <asp:Label ID="lblyhxm" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="form-item">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Button CssClass="btn btn-info" ID="SetBtn" runat="server" Text="执行初始化" OnClick="Set_Click">
                            </asp:Button>
                        </td>
                    </tr>
                </table>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="yhid"
        ErrorMessage="请输入用户编码">&nbsp; </asp:RequiredFieldValidator>
