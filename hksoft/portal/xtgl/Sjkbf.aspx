<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sjkbf.aspx.cs" Inherits="hkpro.portal.xtgl.Sjkbf" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="98%" align="center">
                        <tr>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                                align="center">
                                <a href="Sjkbf.aspx" class="mail_top">数据库备份</a>
                            </td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0" class="form">
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <input type="button" name="AddBtn" value="增 加" class="btn btn-success" onclick="javascript: popAdd('Sjkbf_Bf.aspx');" />
