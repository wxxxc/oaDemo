<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hyqc_Mod.aspx.cs" Inherits="hkpro.oa.hygl.Hyqc_Mod" %>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                        ...
                        <td colspan="2">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:Label ID="fbr_label" runat="server" Enabled="false" Text="起草时间："></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:CheckBox ID="xxtz2" runat="server" Checked="true" Text="站内消息通知会议室管理员" />
                                        <asp:CheckBox ID="dxtz2" runat="server" Text="手机短信通知会议室管理员" />
                                        <asp:CheckBox ID="xxtz" runat="server" Checked="true" Text="站内消息通知参加人员" />
                                        <asp:CheckBox ID="dxtz" runat="server" Text="手机短信通知参加人员" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" align="center" style="height: 30">
                            ...
                            <asp:Button CssClass="mybtn" ID="SendBtn2" runat="server" Text="送审" CausesValidation="true"
                                OnClientClick="return confirm('确认要执行送审吗？')" OnClick="Send_Click2"></asp:Button>
                            <asp:Button ID="DelBtn" Text="删除" OnClick="Del_Click" runat="Server" OnClientClick="return confirm('确认要执行删除吗？')"
                                CausesValidation="false" CssClass="mybtn" />
                            <asp:Button CssClass="mybtn" ID="SendBtn" runat="server" Text="发送通知" OnClick="Send_Click" />
