<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ygtxl_r_add.aspx.cs" Inherits="hkpro.portal.xzgl.Ygtxl_r_add" %>
...
<body class="main">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="Unit" runat="server" Width="11%" Visible="False"></asp:TextBox>
        <asp:TextBox ID="Respon" runat="server" Width="13%" Visible="False"></asp:TextBox>
    </form>
</body>
</html>
