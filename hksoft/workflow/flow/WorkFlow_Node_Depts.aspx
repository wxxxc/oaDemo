<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlow_Node_Depts.aspx.cs"
    Inherits="hkpro.workflow.flow.WorkFlow_Node_Depts" %>
...
<body class="main">
            ...
            <td valign="top" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="fnDeptNames" runat="server" Height="70px" TextMode="MultiLine" Width="90%"
                                CssClass="mytextarea"></asp:TextBox>
                            <img onclick="choosedept();" alt="" src="../../Images/choose.gif" border="0">
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <asp:TextBox ID="fnDeptIDs" runat="server" Style="display: none"></asp:TextBox>
    ...
    <script>
        ...
        function choosedept() {
            var num = Math.random();
            var str = "" + document.getElementById('fnDeptIDs').value + "";
            ...
            if (bstr == '3' | bstr == '4' | bstr == '5') {
                ...
                uIdName = window.showModalDialog("../../Choose/portal/ChooseDept.aspx?tmp=" + num + "&rqstr=" + str + "", "window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");
            }

            var arr = uIdName.split("|");
            for (var i = 0; i < arr.length; i++) {
                document.getElementById("fnDeptIDs").value = arr[0];
                document.getElementById("fnDeptNames").value = arr[1];
            }
        }
