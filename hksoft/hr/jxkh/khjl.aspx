<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="khjl.aspx.cs" Inherits="hksoft.hr.jxkh.khjl" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td style="height: 60px; line-height: 60px;" colspan="2">
                                <span style="padding: 10px">被考核人：</span>
                                ...
                                &nbsp
                                <input type="button" name="AddBtn" value="添加" class="btn btn-primary" onclick="javascript: popWin_m('khjl_add.aspx');" />
                                &nbsp
                                <asp:Button CssClass="btn btn-danger" ID="DelBtn" runat="server" Text="删 除" OnClick="Del_Click"
                                    OnClientClick="return confirm('删除的记录将不能被恢复，确认要执行删除吗？')"></asp:Button>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="考核项目">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="xmname" runat="server" Text='<%# Bind("xmname") %>'></asp:Label></font>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="附件">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <%--<a class="a" href="<%=qy_fjylurl.Text %><%# getfuji(Eval("fjlj").ToString()) %> %>" style='<%# isshowfj(Eval("fjlj").ToString()+Eval("fjlj").ToString()) %>' target="_blank" id="f">在线预览</a>--%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
