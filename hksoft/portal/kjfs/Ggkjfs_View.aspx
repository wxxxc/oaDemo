<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ggkjfs_View.aspx.cs" Inherits="hkpro.portal.kjfs.Ggkjfs_View" %>
...
<body class="main">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="td_base" height="25px" colspan="2">
            ...
            <td valign="top" colspan="2">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="fj" runat="server" CssClass="mytextarea" Width="90%" Rows="3" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
