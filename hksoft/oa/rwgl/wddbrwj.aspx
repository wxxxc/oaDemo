<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wddbrwj.aspx.cs" Inherits="hkpro.oa.rwgl.wddbrwj" %>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs rwgl_nav" role="tablist" style="float: left;">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="wddbrwj.aspx">已办结任务</a> </li>
                                </ul>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="任务标题">
                                                <ItemTemplate>
                                                    <a href="#" onclick="javascript:popView('bjdbrw_yhview.aspx?rwid=<%# Eval("rwid") %>&jszt=<%# Eval("jszt")%>&jsid=<%# Eval("jsid") %>&type=ybj')"
