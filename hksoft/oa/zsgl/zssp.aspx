                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                                            align="center">
                                            <a href="zssp.aspx?i=2" class="mail_top">未审批</a>
                                        </td>
                                        <td style="width: 91px; background-image: url(../../images/tab_b_n.gif)" align="center">
                                            <a href="wzssp.aspx" class="black">已审批</a>
                                        </td>
                                        <td align="right">&nbsp;
                                        </td>
                                    </tr>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            ...
                                            <ItemTemplate>
                                                <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "id") %>);"
                                                    class="gvlink">查看</a> <a href="#" onclick="javascript:popMod('zssp_view.aspx?id=<%# Eval("ID") %>&type=<%=Request.QueryString["Type"] %>')"
                                                        class="gvlink">审批</a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
