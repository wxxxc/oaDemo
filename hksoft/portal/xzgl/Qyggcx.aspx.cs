...
{
    public partial class Qyggcx : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        public void GridViewBind()
        {
            ...
            AspNetPager1.RecordCount = (int)SqlHelper.ExecuteScalar("SELECT COUNT(*) FROM HK_QYGG A,YH B WHERE A.LRR=B.UI_ID AND A.GGLB='1' AND ZT='已发布' " + Str1);
            DataSet ds = SqlHelper.ExecuteDs("SELECT GGID,GGZT,LX,ZT,KSSJ,JSSJ,LRR,LRSJ,UI_DESC FROM HK_QYGG A,YH B WHERE A.LRR=B.UI_ID AND A.GGLB='1' AND ZT='已发布' " + Str1 + " ORDER BY LRSJ DESC", AspNetPager1.PageSize * (AspNetPager1.CurrentPageIndex - 1), AspNetPager1.PageSize);
