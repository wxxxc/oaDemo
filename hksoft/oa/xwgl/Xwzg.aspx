<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xwzg.aspx.cs" Inherits="hkpro.oa.xwgl.Xwzg" %>
            ...
            <tr>
                <td align="center">
                    <table cellspacing="0" cellpadding="0" width="98%" border="0">
                        <tr>
                            <td style="height: 40px">请选择新闻分类：<asp:DropDownList ID="xwfl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ChangeType">
                            </asp:DropDownList>
                            </td>
                            <td align="right">
                                <input type="button" name="AddBtn" value="增加" class="mybtn" onclick="javascript: popAdd('xwzg_view.aspx');" />
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="标题">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('xwzg_view.aspx?id=<%# Eval("xwid") %>')"
                                                    class="gvlink">
