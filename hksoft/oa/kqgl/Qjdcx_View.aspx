<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qjdcx_View.aspx.cs" Inherits="hkpro.oa.kqgl.Qjdcx_View" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="td_base" style="width: 80%; height: 25px">查询请假单明细
                </td>
