<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormDesign_Add.aspx.cs"
    Inherits="hkpro.workflow.form.FormDesign_Add" ValidateRequest="false" %>
...
<script>
    function SetForm(str) {
        ...
        if (str == "18") {
            var num = Math.random();
            window.open("FormDesign_Add_ct.aspx?tmp=" + num + "&Number=" + cValue + "", "_blank", "height=400px, width=400,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
        }
...
<body class="main">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2" style="height: 20" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="FormName" runat="server" Width="90%" MaxLength="10" CssClass="mytext"
                                ToolTip="最多输入10个字符"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="form-item">
        ...
        <tr>
            <td colspan="2">
                <textarea runat="server" id="editor" name="editor" rows="10" cols="10" style="width: 99%; height: 220px;"></textarea>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="2" height="30">
                <asp:Button ID="SaveBtn" runat="server" Text=" 保存 " CssClass="btn btn-success" OnClick="SaveBtn_Click" />
