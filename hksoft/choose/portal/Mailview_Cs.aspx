<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mailview_Cs.aspx.cs" Inherits="hkpro.Choose.portal.Mailview_Cs" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    <title>选择抄送人（通过勾选最前面的方框完成选择）</title>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            <td colspan="2" style="height: 20px">
                                <font color="red">提示：这里只显示用户档案中有E-mail的用户！</font>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                            ...
                            <td colspan="2">
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ui_lx" HeaderText="类型"></asp:BoundField>
