                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            <td style="height: 40px">快速检索：<asp:DropDownList ID="query_tj" runat="server">
                                <asp:ListItem Value="Number" Selected="True">卷库号</asp:ListItem>
                                <asp:ListItem Value="Name">卷库名称</asp:ListItem>
                            ...
                            <td align="right">
                                ...
                                <input type="button" id="AddBtn" name="AddBtn" value="增 加" class="mybtn" onclick="javascript: popAdd('FilesRoom_View.aspx');"
                                    runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="卷库号">
                                        ...
                                        <asp:BoundField DataField="Name" HeaderText="卷库名称">
