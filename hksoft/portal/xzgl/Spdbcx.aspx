<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Spdbcx.aspx.cs" Inherits="hkpro.portal.xzgl.Spdbcx" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="视频名称">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('spdbcx_view.aspx?id=<%# Eval("spid") %>')"
                                                    class="gvlink">
