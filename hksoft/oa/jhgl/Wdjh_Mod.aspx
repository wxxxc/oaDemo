<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wdjh_Mod.aspx.cs" Inherits="hkpro.oa.jhgl.Wdjh_Mod" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="工作主题">
                                    <ItemTemplate>
                                        <a href="#" onclick="javascript:popView('gzx_mod.aspx?type=m&i=<%=istr %>&id=<%# Eval("id") %>&jhid=<%# Eval("jhid") %>')"
                                            class="gvlink">
