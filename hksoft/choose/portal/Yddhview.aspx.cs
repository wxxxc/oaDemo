...
{
    public partial class Yddhview : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        {
            string Str1 = " where ui_status='正常'";
            ...
            DataSet ds = SqlHelper.ExecuteDs("select ui_id,ui_desc,ui_yddh,ui_lx from yh" + Str1, AspNetPager1.PageSize * (AspNetPager1.CurrentPageIndex - 1), AspNetPager1.PageSize);
        ...
        protected void set_null(object sender, EventArgs e)
        {
            ...
            Response.Write("window.opener.document.getElementById(\"jsr\").value='';");
