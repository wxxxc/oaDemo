<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fxdcjg.aspx.cs" Inherits="hkpro.portal.tpgl.Fxdcjg" %>
...
<body class="main">
    ...
    <div align="center">
        <input type="button" name="BackBtn" value="关 闭" class="mybtn" onclick="javascript: window.close()" /></div>
    </form>
</body>
</html>
