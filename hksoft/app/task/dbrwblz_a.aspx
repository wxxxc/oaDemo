<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dbrwblz_a.aspx.cs" Inherits="hksoft.app.task.dbrwblz_a" %>
                                ...
                                <li class="list-group-item">
                                    <a href="wddbrw_ssshow.aspx?rwid=<%#Eval("rwid")%>&jszt=<%# Eval("jszt")%>&jsid=<%# Eval("jsid") %>&type=yjs" data-ajax="false">
                                        ...
                                        class="head" />--%>
                                            ...
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("rwbt").ToString().Length>17?Eval("rwbt").ToString().Substring(0,17)+"…":Eval("rwbt").ToString() %>' Font-Bold="true" />
                                        ...
                                        <div class="info">
                                            ...
                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("fbsj", "{0:MM/dd HH:mm}") %>' ForeColor="Gray"
                                                Font-Size="Small" />
                                        </div>
                                        <div style="clear: both;"></div>
                                    </a>
