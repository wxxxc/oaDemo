<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rwview_yh.aspx.cs" Inherits="hkpro.Choose.oa.rwview_yh" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" align="center" border="0">
                        <tr>
                            ...
                            <td colspan="2" style="height: 20px">选择部门：<asp:DropDownList ID="bm" runat="server" CssClass="mytext" Width="250" 
                                OnSelectedIndexChanged="bm_SelectedIndexChanged" AutoPostBack="True">
