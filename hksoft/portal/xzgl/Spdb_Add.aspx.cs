...
{
    public partial class Spdb_Add : System.Web.UI.Page
    {
        mydb hkdb = new mydb();
        ...
        public void OperQx()
        {
            hkdb.QxValid(SaveAddBtn, "11304a", Session["roleqx"].ToString());
            hkdb.QxValid(SaveBtn, "11304a", Session["roleqx"].ToString());
        }
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            if (s == "SaveAddBtn")
            {
                ...
                splx.SelectedValue = "";
                spjj.Text = "";
                mydb.Alert_Refresh("保存成功,请新增下一条记录！", "Spdb.aspx");
            }
            else
            {
