<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlow_Node_Add.aspx.cs"
    Inherits="hkpro.workflow.flow.WorkFlow_Node_Add" %>
            ...
            <td valign="top" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="fnPosition" runat="server" Width="90%">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:ListBox ID="SourceListBox" runat="server" Height="160px" Width="180px"></asp:ListBox>
                                    </td>
                                    <td align="center" valign="top">
                                    ...
                                    <td align="center" valign="top">
                                        <asp:ListBox ID="TargetListBox" runat="server" Height="160px" Width="180px"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ynEndAudi" runat="server" Width="90%">
