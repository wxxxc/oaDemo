<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wdrc_Add.aspx.cs" Inherits="hkpro.portal.rcgl.Wdrc_Add" %>
...
<body class="main">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    <tr>
                        <td colspan="2">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="zt" runat="server" Width="90%">
                                            <asp:ListItem Text="未开始" Value="0" Selected="true"></asp:ListItem>
                                ...
                                <tr>
                                    <td class="form-item" style="width:80px" hidden="true">
                                       开始时间：
                                    </td>
                                    <td colspan="3">
                                            ...
                                            <tr hidden="true">
                                                ...
                                                <td style="width: 70">
                                                    <asp:DropDownList ID="ssf" runat="server" Width="60" Enabled="false">
                                                        <asp:ListItem Text="00:00" Value="00:00:00"></asp:ListItem>
                                                        ...
                                                        <asp:ListItem Text="08:30" Value="08:30:00"  Selected="true"></asp:ListItem>
                                            ...
                                            <tr hidden="true">
                                                ...
                                                <td style="width: 500">
                                                    <asp:DropDownList ID="esf" runat="server" Width="60" Enabled="false">
                                                        ...
                                                        <asp:ListItem Text="16:30" Value="16:30:00"></asp:ListItem>
                                                        <asp:ListItem Text="17:00" Value="17:00:00"></asp:ListItem>
                                                        <asp:ListItem Text="17:30" Value="17:30:00" Selected="true"></asp:ListItem>
                                                        <asp:ListItem Text="18:00" Value="18:00:00"></asp:ListItem>
                                                        <asp:ListItem Text="18:30" Value="18:30:00"></asp:ListItem>
                                                        <asp:ListItem Text="19:00" Value="19:00:00"></asp:ListItem>
                                                        <asp:ListItem Text="19:30" Value="19:30:00"></asp:ListItem>
                                ...
                                <tr>
                                    <td class="form-item" style="width: 80px;">
                                          <font color="red">*</font>日志描述：
                                    </td>
                                    <td colspan="3">
                                       <textarea required runat="server" id="editor" name="editor" rows="10" cols="10" style="width: 100%; height: 180px;"></textarea>
                                       <%-- <asp:TextBox ID="rcms" runat="server" CssClass="mytextarea" Width="96%" TextMode="multiLine"
                                            Rows="10"></asp:TextBox>--%>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td colspan="2" align="center" style="height: 30">
                            ...
                            <asp:Button CssClass="mybtn" ID="SaveBtn" runat="server" Text="确认提交" OnClick="Save_Click" />
                            <asp:Button ID="Button2" Text="清 空" OnClick="Clear_Click" runat="Server" CausesValidation="false"
                                CssClass="mybtn" />
                            <%--<input type="button" name="BackBtn" value="通知其他人" class="mybtn" onclick="javascript:popMini('../../portal/xxgl/minixx.aspx')" />--%>
   ...
   <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="rczt"
        ErrorMessage="请输入日志主题">&nbsp;
