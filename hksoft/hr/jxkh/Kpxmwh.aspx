<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kpxmwh.aspx.cs" Inherits="hkpro.oa.jxkh.Kpxmwh" %>
                        ...
                        <tbody>
                            <tr>
                                <td style="height: 40px" colspan="2">
                                    ...
                                    参与评委：<asp:TextBox ID="cypw" runat="server" CssClass="mytext" Width="100"></asp:TextBox>
                                    状态：<asp:DropDownList ID="kpzt" runat="server">
                                        <asp:ListItem Text="" Value=""></asp:ListItem>
                                        <asp:ListItem Text="未生效" Value="未生效"></asp:ListItem>
                                        <asp:ListItem Text="已生效" Value="已生效"></asp:ListItem>
                                        <asp:ListItem Text="已暂停" Value="已暂停"></asp:ListItem>
                                        <asp:ListItem Text="已结束" Value="已结束"></asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <input type="button" id="AddBtn" name="AddBtn" value="增加" class="btn btn-success" onclick="javascript:popAdd('Kpxmwh_View.aspx');"
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="考评期数">
                                                ...
                                                <ItemTemplate>
                                                    <a href="#" onclick="javascript:popAdd('Kpxmwh_View.aspx?id=<%# Eval("kpid") %>')" class="gvlink">
