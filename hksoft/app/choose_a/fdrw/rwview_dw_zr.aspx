<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rwview_dw_zr.aspx.cs" Inherits="hksoft.app.choose_a.fdrw.rwview_dw_zr" %>
        ...
        <div data-role="page" id="indexPage" class="cum_index">
            <div class="hf_index">
                <div data-role="header" data-position="fixed" data-theme="b" style="border-bottom-color: white; background: #5295EE; height: 58px">
                    <h1 style="font-weight: 100; color: white; font-size: 18px; text-shadow: none; margin: 1em 30% 0.8em;">选择责任部门</h1>
                    ...
                    <ItemTemplate>
                        <li>
                            <table>
                                <tr>
                                    <td>
                                        <input name="chk" id="<%# Eval("bm_id") %>" type="checkbox"
                                            onclick="javascript:clickemail('<%# Eval("bm_id").ToString()%>    ');" data-role="none" class="input_check" />
                                    </td>
                                    <td>
                                        <h3 class="listtitle">
                                            <asp:Label ID="lblui_name" runat="server" Text='<%# Eval("bm_mc") %>' Font-Bold="true" />
                                        </h3>
                                        <asp:Label ID="lblbyh" runat="server" Text='<%# Eval("cjr") %>' ForeColor="Gray"
                                            Font-Size="Small" />&nbsp;&nbsp;
                                        <asp:Label ID="lblcjsj" runat="server" Text='<%# Eval("cjsj") %>' ForeColor="Gray"
                                            Font-Size="Small" />
