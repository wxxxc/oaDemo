<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kqsmsp2.aspx.cs" Inherits="hkpro.oa.kqgl.Kqsmsp2" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_n.gif)"
                                align="center">
                                <a href="Kqsmsp.aspx" class="black">待审批记录</a>
                            </td>
                            <td style="height: 21px; width: 91px; background-image: url(../../images/tab_b_y.gif)"
                                align="center">
                                <a href="Kqsmsp2.aspx" class="mail_top">已审批记录</a>
                            </td>
                            <td align="right">
                    ...
                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="日期">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <a href="#" onclick="javascript:popView('Kqsmsp2_View.aspx?id=<%# Eval("sssid") %>')"
                                        class="gvlink">
