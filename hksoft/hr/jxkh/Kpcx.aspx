<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kpcx.aspx.cs" Inherits="hkpro.oa.jxkh.Kpcx" %>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="考评期数">
                                                ...
                                                <ItemTemplate>
                                                    <a href="Kpcx_View.aspx?id=<%# Eval("kpid") %>" target="_self" class="gvlink">
                                            ...
                                            <asp:BoundField DataField="jssj" HeaderText="结束时间" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                                <HeaderStyle Width="90" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
