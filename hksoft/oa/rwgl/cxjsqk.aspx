<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cxjsqk.aspx.cs" Inherits="hkpro.oa.rwgl.cxjsqk" %>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="任务标题">
                                                        <ItemTemplate>
                                                            <a href="#" onclick="javascript:popView('ztdbrw_yhview.aspx?rwid=<%# Eval("rwid") %>')"
