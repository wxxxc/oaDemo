<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Spdb_w.aspx.cs" Inherits="hkpro.portal.xzgl.Spdb_w" %>
                    ...
                    <table cellspacing="0" cellpadding="0" width="98%" border="0">
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <input type="button" id="AddBtn" name="AddBtn" value="增加" class="mybtn" onclick="javascript: popAdd('spdb_w_add.aspx');"
                                    runat="server" />
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="视频名称">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:popMod('spdb_w_mod.aspx?id=<%# Eval("spid") %>')"
                                                    class="gvlink">
                                        ...
                                        <asp:BoundField DataField="ynxs" HeaderText="首页显示">
