<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pfclsc.aspx.cs" Inherits="hkpro.oa.jxkh.Pfclsc" %>
                        ...
                        <tbody>
                            <tr>
                                <td style="height: 40px" colspan="2">
                                    ...
                                    状态：<asp:DropDownList ID="kpzt" runat="server" Enabled="false">
                                        <asp:ListItem Text="" Value=""></asp:ListItem>
                                        <asp:ListItem Text="未生效" Value="未生效" Selected="True"></asp:ListItem>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRow_Bound" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="考评期数">
                                                ...
                                                <ItemTemplate>
                                                    <a href="#" onclick="javascript:popAdd('Pfclsc_View.aspx?id=<%# Eval("kpid") %>')" class="gvlink">
                            ...
                            <tr>
                                <td colspan="2" style="height: 22px">
                                <font color="red">注：此模块用于上传各个被考评人的评分材料。</font>
                                </td>
                            </tr>
                        </tbody>
                    </table>
