<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wdmp_Mod.aspx.cs" Inherits="hkpro.oa.mpgl.Wdmp_Mod" %>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                        ...
                        <td colspan="2">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="form">
                                <tr>
                                    ...
                                    <td style="width: 30%">
                                        <asp:TextBox class="mytext" ID="xm" runat="server" Width="90%" MaxLength="5"></asp:TextBox>
                                    </td>
                                    <td class="form-item" style="width: 20%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lrr_label" runat="server" Enabled="false" Text="创建："></asp:Label><asp:Label
                                            ID="lrsj" runat="server" Enabled="false"></asp:Label>
                                        <asp:Label ID="lrr" runat="server" Enabled="false"></asp:Label>
                                    </td>
                                    <td class="form-item">
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td colspan="2" align="center" style="height: 30">
                            <asp:Button CssClass="mybtn" ID="SaveBtn2" runat="server" Text="保存并关闭" OnClick="Save_Click">
                            </asp:Button>
